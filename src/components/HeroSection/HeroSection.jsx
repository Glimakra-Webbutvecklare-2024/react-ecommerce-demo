function HeroSection() {
  return (
    <section className="h-screen w-screen bg-[url(https://celebrateurbanbirds.org/wp-content/uploads/2016/09/stock-photo-garden-in-urban-at-sukumwit-bangkok-360954980-1920x1235.jpg)] flex flex-col p-24 justify-end bg-cover bg-center mb-96">
